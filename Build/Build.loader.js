function createUnityInstance(e, t, n) {
    ...
    function o(e) {
        ...
        if (r.startsWith(n) && (r = r.substring(n.length)), n += "\n" + r.trim(), n && f.stackTraceRegExp && f.stackTraceRegExp.test(n)) {
    ...
    function i(e, t, n) {
        if (e.indexOf("fullscreen error") == -1) {
            ...
            if (!(f.errorHandler && f.errorHandler(e, t, n) || (console.log("Invoking error handler due to\n" + e), "function" == typeof dump && dump("Invoking error handler due to\n" + e), i.didShowErrorMessage))) {
    ...
    function s(e, t) {
        if ("symbolsUrl" != e) {
            ...
            for (var e in f.downloadProgress) {
                ...
                i++, r.lengthComputable ? (o += r.loaded, a += r.total, s++) : r.finished || l++
            }
            ...
            try {
                for (var o in w)
                    if (w[o].hasUnityMarker(e)) {
                        ...
                        return a.worker.callbacks[s] = n, void a.worker.postMessage({
                            id: s,
                            compressed: e
                        }, [e.buffer])
                    }
                    ...
                    if ("undefined" == typeof unityFramework || !unityFramework) {
                        ...
                        for (var a in n) {
                            ...
                            if (f.frameworkUrl.endsWith("." + i[0])) {
                                ...
                                if ("file:" == location.protocol) return void r(s + " Loading pre-compressed (brotli or gzip) content via a file:// URL without a web server is not supported by this browser. Please use a local development web server to host compressed Unity content, or use the Unity Build and Run option.", "error");
                        ...
                        r("Unable to parse " + f.frameworkUrl + "! The file is corrupt, or compression was misconfigured? (check Content-Encoding HTTP Response Header on web server)", "error")
                    }
                    var d = unityFramework;
                    unityFramework = null, o.onload = null, URL.revokeObjectURL(t), e(d)
                }, o.onerror = function(e) {
                    r("Unable to load file " + f.frameworkUrl + "! Check that the file exists on the remote server. (also check browser Console and Devtools Network tab to debug)", "error")
                }, document.body.appendChild(o), f.deinitializers.push(function() {
    ...
    function u() {
        Promise.all([c(), d("codeUrl")]).then(function(e) {
        ...
        f.preRun.push(function() {
            f.addRunDependency("dataUrl"), e.then(function(e) {
                ...
                for (n += 4; n < o;) {
                    ...
                    n += s;
                    for (var d = 0, c = l.indexOf("/", d) + 1; c > 0; d = c, c = l.indexOf("/", d) + 1) f.FS_createPath(l.substring(0, d), l.substring(d, c - 1), !0, !0);
    ...
    document.addEventListener("webkitfullscreenchange", function(t) {
        ...
        n === e ? e.style.width && (b = e.style.width, p = e.style.height, e.style.width = "100%", e.style.height = "100%") : b && (e.style.width = b, e.style.height = p, b = "", p = "")
    }), f.deinitializers.push(function() {
        f.disableAccessToMediaDevices(), m.forEach(function(t) {
    ...
    f.SystemInfo = function() {
        ...
        for (var t, n, r, o, a, i, s = navigator.userAgent + " ", l = [
                ["Firefox", "Firefox"],
                ["OPR", "Opera"],
                ["Edg", "Edge"],
        ...
        return i(e, "", 0), !0
    }, Error.stackTraceLimit = Math.max(Error.stackTraceLimit || 0, 50), f.readBodyWithProgress = function() {
        function e(e, t) {
            if (!t) return 0;
        ...
        function t(t, n) {
            function r() {
                return "undefined" == typeof a ? t.arrayBuffer().then(function(e) {
                    ...
                    return e.done ? o() : (c + e.value.length <= l.length ? (l.set(e.value, c), u = c + e.value.length) : d.push(e.value), c += e.value.length, n({
                        type: "progress",
                        total: Math.max(s, c),
                        loaded: c,
                        lengthComputable: i
            ...
            function o() {
                if (c === s) return l;
                if (c < s) return l.slice(0, c);
                var e = new Uint8Array(c);
                e.set(l, 0);
                for (var t = u, n = 0; n < d.length; ++n) e.set(d[n], t), t += d[n].length;
                return e
            }
        ...
        return t.getInstance = function() {
            ...
            return s ? s.close().then(function() {
                s = null
            }) : Promise.resolve()
        ...
        }, t.UnityCacheDatabase = n, t.RequestMetaDataStore = r, t.MaximumCacheSize = 1073741824, t.prototype.loadRequest = function(e) {
            var t = this;
            return t.isConnected.then(function() {
                return Promise.all([t.cache.match(e), t.loadRequestMetaData(e)])
            }).then(function(e) {
                if ("undefined" != typeof e[0] && "undefined" != typeof e[1]) return {
                    response: e[0],
                    metaData: e[1]
                }
            })
            ...
            var e = this;
            if ("undefined" == typeof i) return Promise.reject(new Error("Could not connect to cache: IndexedDB is not supported."));
            if ("undefined" == typeof window.caches) return Promise.reject(new Error("Could not connect to cache: Cache API is not supported."));
            var t = new Promise(function(t, r) {
                ...
                try {
                    e.openDBTimeout = setTimeout(function() {
                        "undefined" == typeof e.database && r(new Error("Could not connect to cache: Database timeout."))
                    }, 2e4);
                    var a = i.open(n.name, n.version);
                    a.onupgradeneeded = e.upgradeDatabase.bind(e), a.onsuccess = function(n) {
                        o(), e.database = n.target.result, t()
                    }, a.onerror = function(t) {
                        o(), e.database = null, r(new Error("Could not connect to database."))
                    }
                } catch (t) {
                    o(), e.database = null, e.cache = null, r(new Error("Could not connect to cache: Could not connect to database."))
                }
            }).then(function() {
            ...
            if (!t.objectStoreNames.contains(r.name)) {
                var n = t.createObjectStore(r.name, {
                    keyPath: "url"
                });
            ...
            t.objectStoreNames.contains(o.name) && t.deleteObjectStore(o.name), t.objectStoreNames.contains(a.name) && t.deleteObjectStore(a.name)
            ...
            return new Promise(function(o, a) {
                ...
                l.onsuccess = function(e) {
                    ...
                    r ? (t += r.value.size, n.push(r.value), r.continue()) : o({
                        metaDataEntries: n,
                        cacheSize: t
                    })
                }, l.onerror = function(e) {
            ...
            return this.getMetaDataEntries().then(function(n) {
                ...
                function a() {
                    ...
                    var t = l.pop();
                    return e.cache.delete(t.url).then(function(e) {
                        if (e) return o(t.url)
                    }).then(function() {
                        return a()
                    })
                }
                for (var i = n.metaDataEntries, s = n.cacheSize, l = [], d = [], c = 0; c < i.length; ++c) i[c].version != f.productVersion ? (l.push(i[c]), s -= i[c].size) : d.push(i[c]);
                d.sort(function(e, t) {
                    return e.accessedAt - t.accessedAt
                });
                for (var c = 0; c < d.length && !(s < t.MaximumCacheSize); ++c) l.push(d[c]), s -= d[c].size;
                return a()
            })
        }, t
        ...
        function o(o, l) {
            function d(t, n) {
                return fetch(t, n).then(function(r) {
                    ...
                    if (304 === r.status) return f.revalidated = !0, c.updateRequestMetaData(f.metaData).then(function() {
                        e("'" + f.metaData.url + "' successfully revalidated and served from the indexedDB cache")
                    }).catch(function(t) {
                        e("'" + f.metaData.url + "' successfully revalidated but not stored in the indexedDB cache due to the error: " + t)
                    }), s(f.response, n.onProgress);
                    if (200 == r.status) {
                        f.response = r, f.metaData.updatedAt = f.metaData.accessedAt, f.revalidated = !0;
                        var o = r.clone();
                        return s(r, n.onProgress).then(function(n) {
                            return f.metaData.size = n.parsedBody.length, Promise.all([c.storeRequest(t, o), c.updateRequestMetaData(f.metaData)]).then(function() {
                                e("'" + u + "' successfully downloaded and stored in the indexedDB cache")
                            }).catch(function(t) {
                                e("'" + u + "' successfully downloaded but not stored in the indexedDB cache due to the error: " + t)
                            }), n
                        })
                    }
                    return e("'" + u + "' request failed with status: " + r.status + " " + r.statusText), s(r, n.onProgress)
                })
            }
            var c = a.getInstance(),
            ...
            return l && (f.control = l.control, f.companyName = l.companyName, f.productName = l.productName, f.productVersion = l.productVersion), f.revalidated = !1, f.metaData = {
                url: u,
                accessedAt: Date.now(),
                version: f.productVersion
            }, f.response = null, f.enabled ? c.loadRequest(u).then(function(t) {
                if (!t) return d(o, l);
                var r = t.response,
                    a = t.metaData;
                if (f.response = r, f.metaData.size = a.size, f.metaData.updatedAt = a.updatedAt, "immutable" == f.control) return f.revalidated = !0, c.updateRequestMetaData(a).then(function() {
                    e("'" + f.metaData.url + "' served from the indexedDB cache without revalidation")
                }), s(r, l.onProgress);
                if (n(u) && (r.headers.get("Last-Modified") || r.headers.get("ETag"))) return fetch(u, {
                    method: "HEAD"
                }).then(function(t) {
                    return f.revalidated = ["Last-Modified", "ETag"].every(function(e) {
                        return !r.headers.get(e) || r.headers.get(e) == t.headers.get(e)
                    }), f.revalidated ? (c.updateRequestMetaData(a).then(function() {
                        e("'" + f.metaData.url + "' successfully revalidated and served from the indexedDB cache")
                    }), s(f.response, l.onProgress)) : d(o, l)
                });
                l = l || {};
                var i = l.headers || {};
                return l.headers = i, r.headers.get("Last-Modified") ? (i["If-Modified-Since"] = r.headers.get("Last-Modified"), i["Cache-Control"] = "no-cache") : r.headers.get("ETag") && (i["If-None-Match"] = r.headers.get("ETag"), i["Cache-Control"] = "no-cache"), d(o, l)
            }).catch(function(t) {
                return e("Failed to load '" + f.metaData.url + "' from indexedDB cache due to the error: " + t), i(o, l)
            }) : i(o, l)
        }
        var a = f.UnityCache,
            ...
            require: function(e) {
                var t = {
                    "inflate.js": function(e, t, n) {
                        ...
                        function r(e) {
                            ...
                            if (n !== d.Z_OK) throw new Error(c[n]);
                        ...
                        r.prototype.push = function(e, t) {
                            ...
                            do {
                                if (0 === f.avail_out && (f.output = new s.Buf8(m), f.next_out = 0, f.avail_out = m), n = i.inflate(f, d.Z_NO_FLUSH), n === d.Z_NEED_DICT && b && (u = "string" == typeof b ? l.string2buf(b) : "[object ArrayBuffer]" === h.call(b) ? new Uint8Array(b) : b, n = i.inflateSetDictionary(this.strm, u)), n === d.Z_BUF_ERROR && p === !0 && (n = d.Z_OK, p = !1), n !== d.Z_STREAM_END && n !== d.Z_OK) return this.onEnd(n), this.ended = !0, !1;
                                f.next_out && (0 !== f.avail_out && n !== d.Z_STREAM_END && (0 !== f.avail_in || r !== d.Z_FINISH && r !== d.Z_SYNC_FLUSH) || ("string" === this.options.to ? (o = l.utf8border(f.output, f.next_out), a = f.next_out - o, c = l.buf2string(f.output, o), f.next_out = a, f.avail_out = m - a, a && s.arraySet(f.output, f.output, o, a, 0), this.onData(c)) : this.onData(s.shrinkBuf(f.output, f.next_out)))), 0 === f.avail_in && 0 === f.avail_out && (p = !0)
                            } while ((f.avail_in > 0 || 0 === f.avail_out) && n !== d.Z_STREAM_END);
                            return n === d.Z_STREAM_END && (r = d.Z_FINISH), r === d.Z_FINISH ? (n = i.inflateEnd(this.strm), this.onEnd(n), this.ended = !0, n === d.Z_OK) : r !== d.Z_SYNC_FLUSH || (this.onEnd(d.Z_OK), f.avail_out = 0, !0)
                        ...
                        }, n.Inflate = r, n.inflate = o, n.inflateRaw = a, n.ungzip = o
                    },
                    "utils/common.js": function(e, t, n) {
                        ...
                        var o = {
                                arraySet: function(e, t, n, r, o) {
                                    if (t.subarray && e.subarray) return void e.set(t.subarray(n, n + r), o);
                                    for (var a = 0; a < r; a++) e[o + a] = t[n + a]
                                },
                                flattenChunks: function(e) {
                                    var t, n, r, o, a, i;
                                    for (r = 0, t = 0, n = e.length; t < n; t++) r += e[t].length;
                                    for (i = new Uint8Array(r), o = 0, t = 0, n = e.length; t < n; t++) a = e[t], i.set(a, o), o += a.length;
                                    return i
                                }
                            },
                            a = {
                    ...
                    "utils/strings.js": function(e, t, n) {
                        ...
                        s[254] = s[254] = 1, n.string2buf = function(e) {
                            var t, n, r, a, i, s = e.length,
                                l = 0;
                            for (a = 0; a < s; a++) n = e.charCodeAt(a), 55296 === (64512 & n) && a + 1 < s && (r = e.charCodeAt(a + 1), 56320 === (64512 & r) && (n = 65536 + (n - 55296 << 10) + (r - 56320), a++)), l += n < 128 ? 1 : n < 2048 ? 2 : n < 65536 ? 3 : 4;
                            for (t = new o.Buf8(l), i = 0, a = 0; i < l; a++) n = e.charCodeAt(a), 55296 === (64512 & n) && a + 1 < s && (r = e.charCodeAt(a + 1), 56320 === (64512 & r) && (n = 65536 + (n - 55296 << 10) + (r - 56320), a++)), n < 128 ? t[i++] = n : n < 2048 ? (t[i++] = 192 | n >>> 6, t[i++] = 128 | 63 & n) : n < 65536 ? (t[i++] = 224 | n >>> 12, t[i++] = 128 | n >>> 6 & 63, t[i++] = 128 | 63 & n) : (t[i++] = 240 | n >>> 18, t[i++] = 128 | n >>> 12 & 63, t[i++] = 128 | n >>> 6 & 63, t[i++] = 128 | 63 & n);
                            return t
                            ...
                            var n, o, a, i, l = t || e.length,
                                d = new Array(2 * l);
                            for (o = 0, n = 0; n < l;)
                                if (a = e[n++], a < 128) d[o++] = a;
                                else if (i = s[a], i > 4) d[o++] = 65533, n += i - 1;
                            else {
                                for (a &= 2 === i ? 31 : 3 === i ? 15 : 7; i > 1 && n < l;) a = a << 6 | 63 & e[n++], i--;
                    ...
                    "zlib/inflate.js": function(e, t, n) {
                        ...
                        function a(e) {
                            var t;
                            return e && e.state ? (t = e.state, e.total_in = e.total_out = t.total = 0, e.msg = "", t.wrap && (e.adler = 1 & t.wrap), t.mode = z, t.last = 0, t.havedict = 0, t.dmax = 32768, t.head = null, t.hold = 0, t.bits = 0, t.lencode = t.lendyn = new w.Buf32(be), t.distcode = t.distdyn = new w.Buf32(pe), t.sane = 1, t.back = -1, D) : A
                        }

                        function i(e) {
                            var t;
                            return e && e.state ? (t = e.state, t.wsize = 0, t.whave = 0, t.wnext = 0, a(e)) : A
                        }

                        function s(e, t) {
                            var n, r;
                            return e && e.state ? (r = e.state, t < 0 ? (n = 0, t = -t) : (n = (t >> 4) + 1, t < 48 && (t &= 15)), t && (t < 8 || t > 15) ? A : (null !== r.window && r.wbits !== t && (r.window = null), r.wrap = n, r.wbits = t, i(e))) : A
                        }

                        function l(e, t) {
                            var n, r;
                            return e ? (r = new o, e.state = r, r.window = null, n = s(e, t), n !== D && (e.state = null), n) : A
                        }
                        ...
                        function c(e) {
                            if (ve) {
                                var t;
                                for (p = new w.Buf32(512), g = new w.Buf32(32), t = 0; t < 144;) e.lens[t++] = 8;
                                for (; t < 256;) e.lens[t++] = 9;
                                for (; t < 280;) e.lens[t++] = 7;
                                for (; t < 288;) e.lens[t++] = 8;
                                for (_(S, e.lens, 0, 288, p, 0, e.work, {
                                        bits: 9
                                    }), t = 0; t < 32;) e.lens[t++] = 5;
                                _(C, e.lens, 0, 32, g, 0, e.work, {
                                    bits: 5
                                }), ve = !1
                            }
                        ...
                        function u(e, t, n, r) {
                            var o, a = e.state;
                            return null === a.window && (a.wsize = 1 << a.wbits, a.wnext = 0, a.whave = 0, a.window = new w.Buf8(a.wsize)), r >= a.wsize ? (w.arraySet(a.window, t, n - a.wsize, a.wsize, 0), a.wnext = 0, a.whave = a.wsize) : (o = a.wsize - a.wnext, o > r && (o = r), w.arraySet(a.window, t, n - r, o, a.wnext), r -= o, r ? (w.arraySet(a.window, t, n - r, r, 0), a.wnext = r, a.whave = a.wsize) : (a.wnext += o, a.wnext === a.wsize && (a.wnext = 0), a.whave < a.wsize && (a.whave += o))), 0
                        }

                        function f(e, t) {
                            var n, o, a, i, s, l, d, f, h, m, b, p, g, be, pe, ge, we, ve, ye, ke, _e, xe, Se, Ce, Ee = 0,
                                Ue = new w.Buf8(4),
                                Be = [16, 17, 18, 0, 8, 7, 9, 6, 10, 5, 11, 4, 12, 3, 13, 2, 14, 1, 15];
                            if (!e || !e.state || !e.output || !e.input && 0 !== e.avail_in) return A;
                            n = e.state, n.mode === K && (n.mode = Y), s = e.next_out, a = e.output, d = e.avail_out, i = e.next_in, o = e.input, l = e.avail_in, f = n.hold, h = n.bits, m = l, b = d, xe = D;
                            e: for (;;) switch (n.mode) {
                                case z:
                                    if (0 === n.wrap) {
                                        n.mode = Y;
                                    ...
                                    if (2 & n.wrap && 35615 === f) {
                                        n.check = 0, Ue[0] = 255 & f, Ue[1] = f >>> 8 & 255, n.check = y(n.check, Ue, 2, 0), f = 0, h = 0, n.mode = N;
                                        break
                                    }
                                    ...
                                    n.dmax = 1 << _e, e.adler = n.check = 1, n.mode = 512 & f ? G : K, f = 0, h = 0;
                                    break;
                                case N:
                                    for (; h < 16;) {
                                        if (0 === l) break e;
                                    ...
                                    n.head && (n.head.text = f >> 8 & 1), 512 & n.flags && (Ue[0] = 255 & f, Ue[1] = f >>> 8 & 255, n.check = y(n.check, Ue, 2, 0)), f = 0, h = 0, n.mode = F;
                                case F:
                                    for (; h < 32;) {
                                        if (0 === l) break e;
                                        l--, f += o[i++] << h, h += 8
                                    }
                                    n.head && (n.head.time = f), 512 & n.flags && (Ue[0] = 255 & f, Ue[1] = f >>> 8 & 255, Ue[2] = f >>> 16 & 255, Ue[3] = f >>> 24 & 255, n.check = y(n.check, Ue, 4, 0)), f = 0, h = 0, n.mode = M;
                                case M:
                                    for (; h < 16;) {
                                        if (0 === l) break e;
                                        l--, f += o[i++] << h, h += 8
                                    }
                                    n.head && (n.head.xflags = 255 & f, n.head.os = f >> 8), 512 & n.flags && (Ue[0] = 255 & f, Ue[1] = f >>> 8 & 255, n.check = y(n.check, Ue, 2, 0)), f = 0, h = 0, n.mode = Z;
                                case Z:
                                    if (1024 & n.flags) {
                                        for (; h < 16;) {
                                            if (0 === l) break e;
                                        ...
                                        n.length = f, n.head && (n.head.extra_len = f), 512 & n.flags && (Ue[0] = 255 & f, Ue[1] = f >>> 8 & 255, n.check = y(n.check, Ue, 2, 0)), f = 0, h = 0
                                    } else n.head && (n.head.extra = null);
                                    n.mode = j;
                                case j:
                                    if (1024 & n.flags && (p = n.length, p > l && (p = l), p && (n.head && (_e = n.head.extra_len - n.length, n.head.extra || (n.head.extra = new Array(n.head.extra_len)), w.arraySet(n.head.extra, o, i, p, _e)), 512 & n.flags && (n.check = y(n.check, o, p, i)), l -= p, i += p, n.length -= p), n.length)) break e;
                                    n.length = 0, n.mode = H;
                                case H:
                                    if (2048 & n.flags) {
                                        if (0 === l) break e;
                                        p = 0;
                                        do _e = o[i + p++], n.head && _e && n.length < 65536 && (n.head.name += String.fromCharCode(_e)); while (_e && p < l);
                                        if (512 & n.flags && (n.check = y(n.check, o, p, i)), l -= p, i += p, _e) break e
                                ...
                                case W:
                                    if (4096 & n.flags) {
                                        if (0 === l) break e;
                                        p = 0;
                                        do _e = o[i + p++], n.head && _e && n.length < 65536 && (n.head.comment += String.fromCharCode(_e)); while (_e && p < l);
                                        if (512 & n.flags && (n.check = y(n.check, o, p, i)), l -= p, i += p, _e) break e
                                ...
                                case V:
                                    if (0 === n.havedict) return e.next_out = s, e.avail_out = d, e.next_in = i, e.avail_in = l, n.hold = f, n.bits = h, R;
                                ...
                                case Q:
                                    ...
                                    if (n.length = 65535 & f, f = 0, h = 0, n.mode = X, t === B) break e;
                                case X:
                                    n.mode = J;
                                case J:
                                    if (p = n.length) {
                                        if (p > l && (p = l), p > d && (p = d), 0 === p) break e;
                                        w.arraySet(a, o, i, p, s), l -= p, i += p, d -= p, s += p, n.length -= p;
                                        break
                                    }
                                    n.mode = K;
                                    break;
                                ...
                                case ee:
                                    ...
                                    if (n.lencode = n.lendyn, n.lenbits = 7, Se = {
                                            bits: n.lenbits
                                        }, xe = _(x, n.lens, 0, 19, n.lencode, 0, n.work, Se), n.lenbits = Se.bits, xe) {
                                ...
                                case te:
                                    for (; n.have < n.nlen + n.ndist;) {
                                        for (; Ee = n.lencode[f & (1 << n.lenbits) - 1], pe = Ee >>> 24, ge = Ee >>> 16 & 255, we = 65535 & Ee, !(pe <= h);) {
                                            if (0 === l) break e;
                                            l--, f += o[i++] << h, h += 8
                                        }
                                        if (we < 16) f >>>= pe, h -= pe, n.lens[n.have++] = we;
                                        else {
                                            if (16 === we) {
                                                for (Ce = pe + 2; h < Ce;) {
                                                    if (0 === l) break e;
                                                ...
                                                _e = n.lens[n.have - 1], p = 3 + (3 & f), f >>>= 2, h -= 2
                                            } else if (17 === we) {
                                                for (Ce = pe + 3; h < Ce;) {
                                                    if (0 === l) break e;
                                                    l--, f += o[i++] << h, h += 8
                                                }
                                                f >>>= pe, h -= pe, _e = 0, p = 3 + (7 & f), f >>>= 3, h -= 3
                                            } else {
                                                for (Ce = pe + 7; h < Ce;) {
                                                    if (0 === l) break e;
                                                    l--, f += o[i++] << h, h += 8
                                                }
                                                f >>>= pe, h -= pe, _e = 0, p = 11 + (127 & f), f >>>= 7, h -= 7
                                            }
                                    ...
                                    if (n.lenbits = 9, Se = {
                                            bits: n.lenbits
                                        }, xe = _(S, n.lens, 0, n.nlen, n.lencode, 0, n.work, Se), n.lenbits = Se.bits, xe) {
                                        e.msg = "invalid literal/lengths set", n.mode = fe;
                                        break
                                    }
                                    if (n.distbits = 6, n.distcode = n.distdyn, Se = {
                                            bits: n.distbits
                                        }, xe = _(C, n.lens, n.nlen, n.ndist, n.distcode, 0, n.work, Se), n.distbits = Se.bits, xe) {
                                ...
                                case re:
                                    if (l >= 6 && d >= 258) {
                                        e.next_out = s, e.avail_out = d, e.next_in = i, e.avail_in = l, n.hold = f, n.bits = h, k(e, b), s = e.next_out, a = e.output, d = e.avail_out, i = e.next_in, o = e.input, l = e.avail_in, f = n.hold, h = n.bits, n.mode === K && (n.back = -1);
                                        break
                                    }
                                    for (n.back = 0; Ee = n.lencode[f & (1 << n.lenbits) - 1], pe = Ee >>> 24, ge = Ee >>> 16 & 255, we = 65535 & Ee, !(pe <= h);) {
                                        if (0 === l) break e;
                                        l--, f += o[i++] << h, h += 8
                                    }
                                    if (ge && 0 === (240 & ge)) {
                                        for (ve = pe, ye = ge, ke = we; Ee = n.lencode[ke + ((f & (1 << ve + ye) - 1) >> ve)], pe = Ee >>> 24, ge = Ee >>> 16 & 255, we = 65535 & Ee, !(ve + pe <= h);) {
                                            if (0 === l) break e;
                                            l--, f += o[i++] << h, h += 8
                                        }
                                        f >>>= ve, h -= ve, n.back += ve
                                    }
                                    if (f >>>= pe, h -= pe, n.back += pe, n.length = we, 0 === ge) {
                                        n.mode = le;
                                        break
                                    }
                                    if (32 & ge) {
                                ...
                                case ae:
                                    for (; Ee = n.distcode[f & (1 << n.distbits) - 1], pe = Ee >>> 24, ge = Ee >>> 16 & 255, we = 65535 & Ee, !(pe <= h);) {
                                        if (0 === l) break e;
                                        l--, f += o[i++] << h, h += 8
                                    }
                                    if (0 === (240 & ge)) {
                                        for (ve = pe, ye = ge, ke = we; Ee = n.distcode[ke + ((f & (1 << ve + ye) - 1) >> ve)], pe = Ee >>> 24, ge = Ee >>> 16 & 255, we = 65535 & Ee, !(ve + pe <= h);) {
                                            if (0 === l) break e;
                                            l--, f += o[i++] << h, h += 8
                                        }
                                        f >>>= ve, h -= ve, n.back += ve
                                ...
                                case se:
                                    ...
                                    if (p = b - d, n.offset > p) {
                                        ...
                                        p > n.wnext ? (p -= n.wnext, g = n.wsize - p) : g = n.wnext - p, p > n.length && (p = n.length), be = n.window
                                ...
                                case de:
                                    if (n.wrap) {
                                        ...
                                        if (b -= d, e.total_out += b, n.total += b, b && (e.adler = n.check = n.flags ? y(n.check, a, b, s - b) : v(n.check, a, b, s - b)), b = d, (n.flags ? f : r(f)) !== n.check) {
                            ...
                            return e.next_out = s, e.avail_out = d, e.next_in = i, e.avail_in = l, n.hold = f, n.bits = h, (n.wsize || b !== e.avail_out && n.mode < fe && (n.mode < de || t !== E)) && u(e, e.output, e.next_out, b - e.avail_out) ? (n.mode = he, P) : (m -= e.avail_in, b -= e.avail_out, e.total_in += m, e.total_out += b, n.total += b, n.wrap && b && (e.adler = n.check = n.flags ? y(n.check, a, b, e.next_out - b) : v(n.check, a, b, e.next_out - b)), e.data_type = n.bits + (n.last ? 64 : 0) + (n.mode === K ? 128 : 0) + (n.mode === ne || n.mode === X ? 256 : 0), (0 === m && 0 === b || t === E) && xe === D && (xe = L), xe)
                        }
                        ...
                        function m(e, t) {
                            var n;
                            return e && e.state ? (n = e.state, 0 === (2 & n.wrap) ? A : (n.head = t, t.done = !1, D)) : A
                        }

                        function b(e, t) {
                            var n, r, o, a = t.length;
                            return e && e.state ? (n = e.state, 0 !== n.wrap && n.mode !== V ? A : n.mode === V && (r = 1, r = v(r, t, a, 0), r !== n.check) ? I : (o = u(e, t, a, a)) ? (n.mode = he, P) : (n.havedict = 1, D)) : A
                        }
                        var p, g, w = e("../utils/common"),
                            v = e("./adler32"),
                            y = e("./crc32"),
                            k = e("./inffast"),
                            _ = e("./inftrees"),
                            ...
                            we = ge,
                            ve = !0;
                        n.inflateReset = i, n.inflateReset2 = s, n.inflateResetKeep = a, n.inflateInit = d, n.inflateInit2 = l, n.inflate = f, n.inflateEnd = h, n.inflateGetHeader = m, n.inflateSetDictionary = b, n.inflateInfo = "pako inflate (from Nodeca project)"
                    },
                    ...
                    "zlib/inffast.js": function(e, t, n) {
                        ...
                        t.exports = function(e, t) {
                            var n, a, i, s, l, d, c, u, f, h, m, b, p, g, w, v, y, k, _, x, S, C, E, U, B;
                            n = e.state, a = e.next_in, U = e.input, i = a + (e.avail_in - 5), s = e.next_out, B = e.output, l = s - (t - e.avail_out), d = s + (e.avail_out - 257), c = n.dmax, u = n.wsize, f = n.whave, h = n.wnext, m = n.window, b = n.hold, p = n.bits, g = n.lencode, w = n.distcode, v = (1 << n.lenbits) - 1, y = (1 << n.distbits) - 1;
                            e: do {
                                p < 15 && (b += U[a++] << p, p += 8, b += U[a++] << p, p += 8), k = g[b & v];
                                t: for (;;) {
                                    if (_ = k >>> 24, b >>>= _, p -= _, _ = k >>> 16 & 255, 0 === _) B[s++] = 65535 & k;
                                    else {
                                        if (!(16 & _)) {
                                            if (0 === (64 & _)) {
                                                k = g[(65535 & k) + (b & (1 << _) - 1)];
                                        ...
                                        x = 65535 & k, _ &= 15, _ && (p < _ && (b += U[a++] << p, p += 8), x += b & (1 << _) - 1, b >>>= _, p -= _), p < 15 && (b += U[a++] << p, p += 8, b += U[a++] << p, p += 8), k = w[b & y];
                                        n: for (;;) {
                                            if (_ = k >>> 24, b >>>= _, p -= _, _ = k >>> 16 & 255, !(16 & _)) {
                                                if (0 === (64 & _)) {
                                                    k = w[(65535 & k) + (b & (1 << _) - 1)];
                                                    continue n
                                                }
                                            ...
                                            if (S = 65535 & k, _ &= 15, p < _ && (b += U[a++] << p, p += 8, p < _ && (b += U[a++] << p, p += 8)), S += b & (1 << _) - 1, S > c) {
                                            ...
                                            if (b >>>= _, p -= _, _ = s - l, S > _) {
                                                ...
                                                for (; x > 2;) B[s++] = E[C++], B[s++] = E[C++], B[s++] = E[C++], x -= 3;
                                                x && (B[s++] = E[C++], x > 1 && (B[s++] = E[C++]))
                                            } else {
                                                C = s - S;
                                                do B[s++] = B[C++], B[s++] = B[C++], B[s++] = B[C++], x -= 3; while (x > 2);
                                                x && (B[s++] = B[C++], x > 1 && (B[s++] = B[C++]))
                                            }
                                            break
                                        }
                                    }
                            ...
                            x = p >> 3, a -= x, p -= x << 3, b &= (1 << p) - 1, e.next_in = a, e.next_out = s, e.avail_in = a < i ? 5 + (i - a) : 5 - (a - i), e.avail_out = s < d ? 257 + (d - s) : 257 - (s - d), n.hold = b, n.bits = p
                        }
                    },
                    "zlib/inftrees.js": function(e, t, n) {
                        ...
                        t.exports = function(e, t, n, m, b, p, g, w) {
                            var v, y, k, _, x, S, C, E, U, B = w.bits,
                                D = 0,
                                T = 0,
                                R = 0,
                                A = 0,
                            ...
                            for (I = B, A = o; A >= 1 && 0 === Z[A]; A--);
                            if (I > A && (I = A), 0 === A) return b[p++] = 20971520, b[p++] = 20971520, w.bits = 1, 0;
                            for (R = 1; R < A && 0 === Z[R]; R++);
                            for (I < R && (I = R), O = 1, D = 1; D <= o; D++)
                                if (O <<= 1, O -= Z[D], O < 0) return -1;
                            if (O > 0 && (e === s || 1 !== A)) return -1;
                            for (j[1] = 0, D = 1; D < o; D++) j[D + 1] = j[D] + Z[D];
                            for (T = 0; T < m; T++) 0 !== t[n + T] && (g[j[t[n + T]]++] = T);
                            if (e === s ? (F = H = g, S = 19) : e === l ? (F = c, M -= 257, H = u, W -= 257, S = 256) : (F = f, H = h, S = -1), N = 0, T = 0, D = R, x = p, P = I, L = 0, k = -1, z = 1 << I, _ = z - 1, e === l && z > a || e === d && z > i) return 1;
                            for (;;) {
                                C = D - L, g[T] < S ? (E = 0, U = g[T]) : g[T] > S ? (E = H[W + g[T]], U = F[M + g[T]]) : (E = 96, U = 0), v = 1 << D - L, y = 1 << P, R = y;
                                do y -= v, b[x + (N >> L) + y] = C << 24 | E << 16 | U | 0; while (0 !== y);
                                for (v = 1 << D - 1; N & v;) v >>= 1;
                                if (0 !== v ? (N &= v - 1, N += v) : N = 0, T++, 0 === --Z[D]) {
                                    if (D === A) break;
                                    D = t[n + g[T]]
                                }
                                if (D > I && (N & _) !== k) {
                                    for (0 === L && (L = I), x += R, P = D - L, O = 1 << P; P + L < A && (O -= Z[P + L], !(O <= 0));) P++, O <<= 1;
                                    if (z += 1 << P, e === l && z > a || e === d && z > i) return 1;
                                    k = N & _, b[k] = I << 24 | P << 16 | x - p | 0
                                }
                            }
                            return 0 !== N && (b[x + N] = D - L << 24 | 64 << 16 | 0), w.bits = I, 0
                        }
                    }
                };
                ...
                var r = function(e) {
                    ...
                    a = function(e, t) {
                        ...
                        return n.exports || (n.parent = e, n(a.bind(null, n), n, n.exports = {})), n.exports
                    };
                return a(null, e)
            },
    ...
    return new Promise(function(e, t) {
        if (f.SystemInfo.hasWebGL)
            if (1 == f.SystemInfo.hasWebGL) {
                ...
                "Safari" == f.SystemInfo.browser && parseInt(f.SystemInfo.browserVersion) < 15 && (r += f.SystemInfo.mobile || navigator.maxTouchPoints > 1 ? "\nUpgrade to iOS 15 or later." : "\nUpgrade to Safari 15 or later."), t(r)
            } else f.SystemInfo.hasWasm ? (f.startupErrorHandler = t, n(0), f.postRun.push(function() {
                n(1), delete f.startupErrorHandler, e(g)
            }), u()) : t("Your browser does not support WebAssembly.");
